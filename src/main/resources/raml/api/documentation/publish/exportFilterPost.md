...
<td>The path given determines the starting point for the relative path. E.g. ``startFolder`` /a/b/c results in objects starting with relative path c/... in the exported archive. Only used in conjunction with ``useShortPath``.</td>
<td></td>
<td>/a/b/c</td>
</tr>
<tr>
...
<td style="padding-left:80px;">``objectType``</td>
<td>required, enum</td>
<td>Subset of releasable objects from the enum ConfigurationType. Subset consist of SCHEDULE, "JOBTEMPLATE", "INCLUDESCRIPT", "REPORT", WORKINGDAYSCALENDAR, NONWORKINGDAYSCALENDAR and FOLDER.</td>
...
<tr>
<td style="padding-left:40px;">``inclAllTags``</td>
<td>optional, boolean</td>
